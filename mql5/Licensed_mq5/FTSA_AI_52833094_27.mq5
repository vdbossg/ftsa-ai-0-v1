...
string LICENSE_BROKER   = "Alpari";
string LICENSE_LOGIN    = "52833094";
string LICENSE_EXPIRY   = "2026.04.09";
string LICENSE_KEY      = "LIC_TEST_STEP_19012159156R9";
...
jsonUpdate += "\"entry\":" + DoubleToString(price, _Digits) + ",";
